...
if ($_SESSION['mtuid']==""){ 
 header ('Location: ../.');
	...
	$query=mysql_query("select p_name from s_profile where p_id='".$_GET['pid']."'") or die(mysql_error());
	$ds=mysql_fetch_array($query); $pagename='adms'; $pagegroup='st';	?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $ds[0]; ?> Menu Edit</title>
...
<br /><br /><div style="height: 400px; overflow: scroll;">
<table style="width: auto;" id="menulist">  
